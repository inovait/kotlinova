## [2.15.0](https://github.com/inovait/kotlinova/compare/v2.14.0...v2.15.0) (2020-10-06)

### Features

* **android:** add doOnUpdate() extension function ([9d2a1379](https://github.com/inovait/kotlinova/commit/9d2a137991b73faa21ef4a9099f226b9c8a8abbe))

## [2.14.0](https://github.com/inovait/kotlinova/compare/v2.13.0...v2.14.0) (2020-08-11)

### Features

* **android:** add fragment manager extension function isInBackStack ([6e201903](https://github.com/inovait/kotlinova/commit/6e2019038c87b6736c487a5776819f811b315bbb))

## [2.13.0](https://github.com/inovait/kotlinova/compare/v2.12.0...v2.13.0) (2020-08-07)

### Features

* **android:** add fragment auto cleared value ([a7f0b4e6](https://github.com/inovait/kotlinova/commit/a7f0b4e61237249bcceb2202c59dc9f0d4a87486))

## [2.12.0](https://github.com/inovait/kotlinova/compare/v2.11.1...v2.12.0) (2020-08-04)

### Features

* **android:** add showWithFade, hideWithFade and setVisibilityWithFade methods ([76244098](https://github.com/inovait/kotlinova/commit/762440982ff7160c5bd78148a048b8b7173a9466))

### Bug Fixes

* **android:** use predefined value for fade animation time ([3c62d972](https://github.com/inovait/kotlinova/commit/3c62d972ebad709abe1a1f4c171debdddba9c4cc))

## [2.11.1](https://github.com/inovait/kotlinova/compare/v2.11.0...v2.11.1) (2020-06-24)

### Bug Fixes

* **android:** use weak set for observers to prevent memory leak ([e5f2caf1](https://github.com/inovait/kotlinova/commit/e5f2caf1a1da71eeb2a6edde6ead31b50acef5a4))

## [2.11.0](https://github.com/inovait/kotlinova/compare/v2.10.0...v2.11.0) (2020-06-16)

### Features

* **android:** support enums in shared preferences ([14c7e056](https://github.com/inovait/kotlinova/commit/14c7e056407f192de4bff8a1291079f832b187d1))

## [2.10.0](https://github.com/inovait/kotlinova/compare/v2.9.6...v2.10.0) (2020-05-12)

### Features

* **retrofit:** add support for 204 returns in ErrorHandlerCallAdapterFactory ([9b262082](https://github.com/inovait/kotlinova/commit/9b262082aab3c6e96e30c9ab8905e7b955a45ceb))
* **core:** add containsOnly utility ([06c212b2](https://github.com/inovait/kotlinova/commit/06c212b2a1f036e8a0d9d59e6fd9672314990869))
* **core:** add update loop method for AtomicReference ([373db16b](https://github.com/inovait/kotlinova/commit/373db16bd35ee585c7b6ce3f29ea4686d28afd1a))
* **core:** add MulticastFlow ([4c9788df](https://github.com/inovait/kotlinova/commit/4c9788df764404eadd7a9bd5535b1bac16f0b601))
* require RX java use to be explicit ([7f008cfd](https://github.com/inovait/kotlinova/commit/7f008cfdc85c683d1c2fcbfda39a561229f38a22))
* **android:** add ListObserver test utility ([4f785474](https://github.com/inovait/kotlinova/commit/4f785474c6386ac91f3032285b57404727df5e21))
* **android:** add flow extensions to LiveData ([4c0ac5f3](https://github.com/inovait/kotlinova/commit/4c0ac5f3095516b16b2e13397a7429e533280eea))

### Bug Fixes

* use android injector since dagger removed individually injectors ([3f5020a8](https://github.com/inovait/kotlinova/commit/3f5020a8096e53f8838c3017f6a80cadebff4ec7))
