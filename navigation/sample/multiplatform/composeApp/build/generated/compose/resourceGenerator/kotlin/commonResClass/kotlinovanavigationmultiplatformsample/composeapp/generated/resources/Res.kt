...
internal object Res {
   ...
   public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/kotlinovanavigationmultiplatformsample.composeapp.generated.resources/" + path)
   ...
   public fun getUri(path: String): String =
      getResourceUri("composeResources/kotlinovanavigationmultiplatformsample.composeapp.generated.resources/" + path)
